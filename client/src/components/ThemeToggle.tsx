    ...
    <StyledWrapper>
      <label id="theme-toggle-button">
        ...
        <svg viewBox="0 0 69.667 44" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <filter id="container-filter" x="-3.5" y="-3.5" width="67.667" height="42" filterUnits="userSpaceOnUse">
            ...
            <filter id="sun-outer-filter" x="-5.833" y="-5.833" width="42" height="42" filterUnits="userSpaceOnUse">
              <feOffset dy="3" input="SourceAlpha" />
            ...
            <filter id="sun-filter" x="-5.833" y="-5.833" width="42" height="42" filterUnits="userSpaceOnUse">
              <feOffset dy="3" input="SourceAlpha" />
            ...
            <filter id="moon-filter" x="-31.5" y="-5.833" width="42" height="42" filterUnits="userSpaceOnUse">
              <feOffset dy="3" input="SourceAlpha" />
            ...
            <filter id="cloud-filter" x="-3.5" y="-3.5" width="67.667" height="42" filterUnits="userSpaceOnUse">
              <feOffset dy="3" input="SourceAlpha" />
          ...
          <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
            ...
            <g transform="translate(2.333 2.333)" id="button">
              ...
              <g data-name="moon" id="moon">
                <g filter="url(#moon-filter)" transform="matrix(1, 0, 0, 1, -31.5, -5.83)">
            ...
            <g filter="url(#cloud-filter)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
              <path fill="#fff" transform="translate(-3466.47 -160.94)" d="M3512.81,173.815a4.463,4.463,0,0,1,2.243.62.95.95,0,0,1,.72-1.281,4.852,4.852,0,0,1,2.623.519c.034.02-.5-1.968.281-2.716a2.117,2.117,0,0,1,2.829-.274,1.821,1.821,0,0,1,.854,1.858c.063.037,2.594-.049,3.285,1.273s-.865,2.544-.807,2.626a12.192,12.192,0,0,1,2.278.892c.553.448,1.106,1.992-1.62,2.927a7.742,7.742,0,0,1-3.762-.3c-1.28-.49-1.181-2.65-1.137-2.624s-1.417,2.2-2.623,2.2a4.172,4.172,0,0,1-2.394-1.206,3.82,3.82,0,0,1-2.393,1.206c-1.206,0-2.623-2.2-2.623-2.2s.144,2.134-1.137,2.624a7.742,7.742,0,0,1-3.762.3c-2.727-.935-2.174-2.479-1.62-2.927a12.192,12.192,0,0,1,2.278-.892c.058-.082-1.5-.03,-.807-2.626s3.222-1.236,3.285-1.273a1.821,1.821,0,0,1,.854-1.858,2.117,2.117,0,0,1,2.829.274c.781.748.247,2.736.281,2.716a4.852,4.852,0,0,1,2.623-.519.95.95,0,0,1,.72,1.281A4.463,4.463,0,0,1,3512.81,173.815Z" data-name="cloud" id="cloud-3" />
            </g>
